...
export default function CompanyDashboardPage() {
  ...
  const canReadCompany = currentUser?.permissions.includes("company.read") ?? false;
      ...
      <section className="dashboard-main">
        ...
        {!canReadCompany ? (
          <section className="access-panel" role="alert" aria-live="polite">
            ...
            <h2>You do not have permission to view company details.</h2>
            <p>
              Ask a company administrator to grant <strong>company.read</strong> to your role.
            </p>
          </section>
        ) : (
          <>
            <section className="dashboard-hero">
              <div>
                ...
                <p>
                  This panel shows the current tenant profile and your assigned workspace access
                  in one place.
                </p>
              </div>
            </section>

            <section className="company-details-grid" aria-label="Company and user details">
