...
const permissions = [
  ...
  { key: "purchases.submit", module: "purchases", action: "submit", description: "Submit purchase orders for approval" },
  { key: "purchases.approve", module: "purchases", action: "approve", description: "Approve purchase orders" },
  { key: "purchases.reject", module: "purchases", action: "reject", description: "Reject purchase orders" },
